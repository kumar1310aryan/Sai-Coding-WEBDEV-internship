  ...
  <body id = "home">
    ...
    <div class = "intro-header">
      <div class = "col-xs-12 text-center">
        ...
        <h3 class = "h3_home wow fadeIn" data-wow-delay = "0.6s">College Signup</h3>
        ...
        <div class="login">
          <form action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]);?>" method="POST" name="login" >
            ...
            <h5 class = "h3_home wow fadeIn" data-wow-delay = "1.6s">Signup as a <a style="color:white" href="signup_student.php">&nbsp;&nbsp;Student</u></a></h5>
          </form>
