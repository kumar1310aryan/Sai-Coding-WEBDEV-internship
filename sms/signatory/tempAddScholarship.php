									...
									<section>
										...
										<header>
                         				...
                         				<form method = "post" name = "scholarshiplist" id = "scholarshiplist" action = "../backend/adminAddDelSch.php" enctype="multipart/form-data">
				                            ...
				                            <label style="font-size: 15px;">Institute Name</label>
				                            <br><input type = "text" name = "schname" placeholder="Eg: Dr. Shyama Prasad Mukherjee University Ranchi" required>
				                            <br><br>
				                            ...
				                            <br><input type = "text" name = "schlocation" placeholder="Jharkhand">
				                            <br><br>
				                            ...
				                            <label style="font-size: 15px;">This is a scholarship for a particular Category ...</label><br>
				                            <input type="checkbox" name="category[]" value="BCI"> BC-I<br>
				                            <input type="checkbox" name="category[]" value="BCII"> BC-II<br>
				                            <input type="checkbox" name="category[]" value="general"> General<br>
				                            <input type="checkbox" name="category[]" value="sc"> SC<br>
				                            <input type="checkbox" name="category[]" value="st"> ST<br>
