<?php
  ...
  $upMail=$firstName=$lastName=$middleName=$nationality=$gender=$birthPlace=$permProvCity=$permStreetAddr=$permRegion=$contactNo=$dept=$college=$birthDate= NULL;
  //Get User Details
                      ...
                      <div id="editDiv" style="display:none">
                          <form method="POST" action="../backend/userdata.php" class="form-horizontal" role="form">
                            ...
                            <!-- <div class="form-group">
                              ...
                              <div class="col-sm-10">
                                <input type="name" class="form-control" name="presStreetAddr" value="" >
                              </div> -->
                            <!-- </div>
                            <div class="form-group">
                              <label class="control-label col-sm-2" for="presProvCity">Present City:</label>
                              <div class="col-sm-10">
                                <input type="name" class="form-control" name="presProvCity" value="">
                              </div> -->
                            <!-- </div>
                            <div class="form-group">
                              <label class="control-label col-sm-2" for="presRegion">Present Region:</label>
                              <div class="col-sm-10">
                                <input type="name" class="form-control" name="presRegion" value="">
                              </div>
                            </div> -->
                            <div class="form-group">
                              <label class="control-label col-sm-2" for="permStreetAddr">Permanent Street Address:</label>
